#!/usr/bin/python3
"""
This Nagios/Icinga plugin can be used to monitor percentage of alive streams at flussonic server, and draw some other parameters

Author: Evgeniy Kozhuhovskiy <ugenk@mediatech.by>, 2021-2023
"""
...
parser.add_argument('-H', '--host', help='flussonic host, e.g. 1.2.3.4 or dns name', type=str)
...
parser.add_argument('-s', '--https', help='use https', type=bool, default=False)
...
if args.host:
    ...
    try:
        ...
        if e.code == 404: # guess that we've found old flussonic
